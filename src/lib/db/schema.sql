-- Re-export of supabase/migrations/20260919_initial_schema.sql for in-tree reference
-- See supabase/migrations/20260919_initial_schema.sql for the canonical migration file.
